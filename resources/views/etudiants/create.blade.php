        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="form-container">
                ...
                <div class="form-section">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Ajouter un Étudiant</p>
                    ...
                    <form action="{{ isset($etudiant) ? route('etudiants.update', $etudiant->id) : route('etudiants.store') }}" method="post">
                        ...
                        <div class="flex items-center justify-end">
                            <button type="submit" class="form-button" wire:loading.attr="disabled" wire:target="photo">Ajouter</button>
                        </div>
                    </form>
                </div>
            </div>
